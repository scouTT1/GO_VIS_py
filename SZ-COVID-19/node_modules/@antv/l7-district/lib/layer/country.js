...
var CountryLayer = function (_BaseLayer) {
  ...
  (0, _createClass2.default)(CountryLayer, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                countryConfig = (0, _index.getDataConfig)(this.options.geoDataLevel).CHN[depth];
                _context.next = 4;
    ...
    key: "addNationBorder",
    value: function () {
      var _addNationBorder = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee5(boundaries, boundaries2) {
