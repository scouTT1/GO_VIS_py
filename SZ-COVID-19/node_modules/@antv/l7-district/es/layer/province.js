...
var ProvinceLayer = function (_BaseLayer) {
  ...
  _createClass(ProvinceLayer, [{
    key: "updateDistrict",
    value: function updateDistrict(adcode) {
      var _this$options$bubble;

      var newData = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
      var joinByField = arguments.length > 2 ? arguments[2] : undefined;
    ...
    value: function () {
      var _addProvinceFillLayer = _asyncToGenerator(_regeneratorRuntime.mark(function _callee() {
        var _ref, depth, adcode, countryConfig, fillData, data, labelData;

        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _ref = this.options, depth = _ref.depth, adcode = _ref.adcode;
    ...
    value: function () {
      var _addProvinceLineLayer = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2() {
