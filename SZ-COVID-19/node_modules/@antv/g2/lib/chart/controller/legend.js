...
var Legend = /** @class */ (function (_super) {
    ...
    Legend.prototype.layout = function () {
        ...
        util_1.each(this.components, function (co) {
            ...
            var _a = direction_1.directionToPosition(_this.view.coordinateBBox, bbox, direction), x1 = _a[0], y1 = _a[1];
    ...
    Legend.prototype.mergeLegendCfg = function (baseCfg, legendOption, direction) {
        var themeObject = util_1.get(this.view.getTheme(), ['components', 'legend', direction], {});
