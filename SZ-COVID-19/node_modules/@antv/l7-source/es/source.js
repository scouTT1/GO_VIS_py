...
var Source = function (_EventEmitter) {
  ...
  function Source(data, cfg) {
    ...
    if (cfg) {
      ...
      if (cfg.clusterOptions) {
        _this.cluster = true;
        _this.clusterOptions = _objectSpread(_objectSpread({}, _this.clusterOptions), cfg.clusterOptions);
      }
    }
  ...
  _createClass(Source, [{
    ...
    value: function updateClusterData(zoom) {
      ...
      var data = this.clusterIndex.getClusters(this.extent, Math.floor(zoom));
