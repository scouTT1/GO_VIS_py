...
var TAAPass = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_types.TYPES.IShaderModuleService), _dec3 = (0, _inversify.inject)(_types.TYPES.ILogService), _dec(_class = (_class2 = (_temp = function (_BaseNormalPass) {
  ...
  function TAAPass() {
    ...
    (0, _initializerDefineProperty2.default)(_this, "shaderModuleService", _descriptor, (0, _assertThisInitialized2.default)(_this));
  ...
  return TAAPass;
}(_BaseNormalPass2.default), _temp), (_descriptor = (0, _applyDecoratedDescriptor2.default)(_class2.prototype, "shaderModuleService", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
