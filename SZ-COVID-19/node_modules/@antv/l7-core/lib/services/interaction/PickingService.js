  ...
  (0, _createClass2.default)(PickingService, [{
    ...
    value: function () {
      var _pickingLayers = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee2(target) {
        ...
        var _this$rendererService3, getViewportSize, useFramebuffer, clear, _getViewportSize3, width, height;

        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this$rendererService3 = this.rendererService, getViewportSize = _this$rendererService3.getViewportSize, useFramebuffer = _this$rendererService3.useFramebuffer, clear = _this$rendererService3.clear;
